<%@ Page Title="" Language="C#" MasterPageFile="~/Ogretmen.Master" AutoEventWireup="true" CodeBehind="OgrenciEkle.aspx.cs" Inherits="SiteOgrenciOtomasyon.OgrenciEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="Form1" runat="server" >    
         ...
         <div class="form-group">
             <div>
                <asp:Label for="TxtNumara" runat="server">Öğrenci Numarası</asp:Label>
